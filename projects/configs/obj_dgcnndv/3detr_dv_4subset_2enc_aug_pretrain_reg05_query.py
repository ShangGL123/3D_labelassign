...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        as_two_stage=False,
        transformer=dict(
            type='DeformableDetrTransformer_query',
            encoder=dict(
...
train_pipeline = [
    ...
    dict(type='PointSample', num_points=255000),
...
evaluation = dict(interval=2, pipeline=eval_pipeline, start=0)
...
load_from='/ghome/changjh/detr3d/mmdetection3d/checkpoints/voxel.pth'
