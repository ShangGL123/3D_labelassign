...
class DynamicVFE(nn.Module):
    ...
    def forward(self,
        ...
        if self._with_cluster_center:
            # print(features.shape, coors.shape)  输出：torch.Size([516418, 5]) torch.Size([516418, 4])
            voxel_mean, mean_coors = self.cluster_scatter(features, coors)   # 输出M1M2 concat
        ...
        if self._with_voxel_center:
            ...
            f_center[:, 0] = features[:, 0] - (                                # 点云坐标系xyz对应体素坐标系zyx
